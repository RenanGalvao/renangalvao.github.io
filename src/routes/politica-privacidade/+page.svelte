...
<svelte:head>
	<title>Renan Galvão - Política de Privacidade</title>
	<meta name="title" content="Renan Galvão - Política de Privacidade" />
	<meta name="description" content="Política de Privacidade do site" />
	<meta name="keywords" content="política de privacidade, cookies, compromisso" />
</svelte:head>

<NavBar />
<main class="container w-full mt-8 lg:mt-12 lg:min-h-[calc(100vh-12rem)]">
	<h2 class="text-2xl">Política Privacidade</h2>
	<p class="indent-4 text-justify mb-2">
		A sua privacidade é importante para nós. É política do RenanGalvao.github.io respeitar a sua privacidade em relação
		a qualquer informação sua que possamos coletar no site <a href="https://renangalvao.github.io"
			>RenanGalvao.github.io</a
	...
	<h2 class="text-2xl mb-1 mt-4">Segurança do site RenanGalvao.github.io</h2>
	<p class="indent-4 text-justify">
		O site é confiável e seguro para o usuário conforme informado pelo <a
			target="_blank"
			href="https://sitecheck.com.br"
			rel="noopener noreferrer">Site Check</a
		>. A página verifica informações do site para identificar possíveis problemas de segurança.
	</p>
	<h2 class="text-2xl mb-1 mt-4">Política de Cookies RenanGalvao.github.io</h2>
	<h3 class="text-xl mb-1 mt-4">O que são cookies?</h3>
	<p class="indent-4 text-justify">
		Como é prática comum em quase todos os sites profissionais, este site usa cookies, que são pequenos arquivos
		baixados no seu computador, para melhorar sua experiência. Esta página descreve quais informações eles coletam, como
		as usamos e por que às vezes precisamos armazenar esses cookies. Também compartilharemos como você pode impedir que
		esses cookies sejam armazenados, no entanto, isso pode fazer o downgrade ou 'quebrar' certos elementos da
		funcionalidade do site.
	</p>
	<h3 class="text-xl mb-1 mt-4">Como usamos os cookies?</h3>
	<p class="indent-4 text-justify">
		Utilizamos cookies por vários motivos, detalhados abaixo. Infelizmente, na maioria dos casos, não existem opções
	...
	<h3 class="text-xl mb-1 mt-4">Desativar cookies</h3>
	<p class="indent-4 text-justify">
	...
	<h3 class="text-xl mb-1 mt-4">Cookies que definimos</h3>
	<ul class="mt-2 mb-4 list-inside list-disc">
		<li>
			<b>Cookies relacionados à conta:</b> Se você criar uma conta conosco, usaremos cookies para o gerenciamento do
			processo de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair do sistema,
			porém, em alguns casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao sair.
		</li>
		<li>
			<b>Cookies relacionados ao login:</b> Utilizamos cookies quando você está logado, para que possamos lembrar
			dessa ação. Isso evita que você precise fazer login sempre que visitar uma nova página. Esses cookies são
			normalmente removidos ou limpos quando você efetua logout para garantir que você possa acessar apenas a recursos e
			áreas restritas ao efetuar login.
		</li>
		<li>
			<b>Cookies relacionados a boletins por e-mail:</b> Este site oferece serviços de assinatura de boletim
		...
		<li>
			<b>Pedidos processando cookies relacionados:</b> Este site oferece facilidades de comércio eletrônico ou
		...
		<li>
			<b>Cookies relacionados a pesquisas:</b> Periodicamente, oferecemos pesquisas e questionários para fornecer
		...
		<li>
			<b>Cookies relacionados a formulários:</b> Quando você envia dados por meio de um formulário como os
		...
		<li>
			<b>Cookies de preferências do site:</b> Para proporcionar uma ótima experiência neste site, fornecemos a
			funcionalidade para definir suas preferências de como esse site é executado quando você o usa. Para lembrar suas
			preferências, precisamos definir cookies para que essas informações possam ser chamadas sempre que você interagir
			com uma página for afetada por suas preferências.
		</li>
	</ul>
	<h3 class="text-xl mb-1 mt-4">Cookies de Terceiros</h3>
	<p class="indent-4 text-justify">
	...
	<ul class="mt-2 mb-4 list-inside list-disc">
		<li>
			Este site usa o <a href="https://analytics.google.com/analytics/web/">Google Analytics</a>, que é uma das soluções
			de análise mais difundidas e confiáveis ​​da Web, para nos ajudar a entender como você usa o site e como podemos
			melhorar sua experiência. Esses cookies podem rastrear itens como quanto tempo você gasta no site e as páginas
	...
	<ul class="mt-2 mb-4 list-inside list-disc">
		<li>
			As análises de terceiros são usadas para rastrear e medir o uso deste site, para que possamos continuar produzindo
			conteúdo atrativo. Esses cookies podem rastrear itens como o tempo que você passa no site ou as páginas visitadas,
			o que nos ajuda a entender como podemos melhorar o site para você.
		</li>
		<li>
			Periodicamente, testamos novos recursos e fazemos alterações subtis na maneira como o site se apresenta. Quando
	...
	<h3 class="text-xl mb-1 mt-4">Compromisso do Usuário</h3>
	<p class="indent-4 text-justify">
		O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o RenanGalvao.github.io oferece no
		site e com caráter enunciativo, mas não limitativo:
	</p>
	<ul class="mt-2 mb-4 list-inside">
		<li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
		<li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, ou casas de apostas, jogos de sorte e
			azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;
		</li>
		<li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do RenanGalvao.github.io, de seus
	...
	<h3 class="text-xl mb-1 mt-4">Bloquear cookies:</h3>
	<p class="indent-4 text-justify">
		O usuário pode bloquear e/ou desativar os cookies de qualquer site, inclusive o nosso a qualquer momento. Para
		realizar esse procedimento, acesse as configurações do seu browser. Consulte abaixo guias de ajuda dos principais
		navegadores:
	</p>
	<ul class="mt-2 mb-4 list-inside list-disc">
		<li>
			<a target="_blank" rel="noopener noreferrer" href="https://support.google.com/accounts/answer/61416?hl=en">
				Google Chrome
			</a>
		</li>
		<li>
		...
		<li>
			<a target="_blank" rel="noopener noreferrer" href="https://support.apple.com/pt-br/guide/safari/sfri11471/mac">
				Safari
			</a>.
		</li>
	</ul>
	<h3 class="text-xl mb-1 mt-4">Mais informações</h3>
	<p class="indent-4 text-justify">
		Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se
		precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa
		em nosso site.
	</p>
	<p class="indent-4 text-justify">Esta política é efetiva a partir de <strong>Agosto de 2024</strong>.</p>
</main>
<Footer />